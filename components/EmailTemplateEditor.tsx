    ...
    <form onSubmit={save} className="rounded-[24px] border border-white/10 bg-neutral-950 p-5">
      <div className="flex items-start justify-between gap-4">
        ...
        <input
          ...
          className="w-24 rounded-full border border-white/10 bg-black px-3 py-2 text-xs"
      ...
      <input
        ...
        className="mt-4 w-full rounded-2xl border border-white/10 bg-black px-4 py-3 text-sm outline-none"
        placeholder="Subject"
      />
      <textarea
        value={body}
        ...
        rows={5}
        className="mt-3 w-full rounded-2xl border border-white/10 bg-black px-4 py-3 text-sm outline-none"
